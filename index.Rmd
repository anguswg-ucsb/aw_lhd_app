...
```{r context="server"}
shinyalert::useShinyalert(rmd = TRUE)
...
# 
knitr::include_graphics("data/app_data/low_head_dam_border.jpg")
```
...
<h4>**2.**	Select an LHD on the map to view the score breakdown for each interest domain. You may also select an LHD by clicking on a point in the Rank plot, on the bottom right, or by typing in an LHD ID number in the text box.</h4>
...
#    trigger = '', 
#    size = 'large', 
#    p("here is my mumbo jumbo")
#    )
# # shinyalert::shinyalert("Welcome", "Welcome to the ___ Dashboard!", type = "info")
# shinyBS::toggleModal(session, "lhdMap", toggle = "open")
```
