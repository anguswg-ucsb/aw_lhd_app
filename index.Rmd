...
output$scoreTable <- DT::renderDT({
    DT::datatable(
     ...
     DT::formatRound(columns = c('Total Score', 'Aquatic Health', 'Watershed Condition', 
                                 'Public Safety', 'Recreation' ,'Latitude', 'Longitude'),  digits = 2)
  })
